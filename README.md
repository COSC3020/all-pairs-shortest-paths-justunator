[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11754459&assignment_repo_type=AssignmentRepo)
...
The worst-case should be $\Theta(V^3)$ as my implementation has 3 for loops nested inside of each other each running for $V$ times. The rest of the code runs faster then $V^3$ time so they do not matter.
